...
// const ACCESS_TOKEN =
//   "pk.eyJ1IjoibGFpOTYiLCJhIjoiY2xpdTR0a2l1MXQ1MzNrbzFxYXJjbHpnMiJ9.a2BdOPmz-GAhmXFvwho5Og";
...
//       <form>
//         <label htmlFor="destination">Type a location</label>
//         <input placeholder="e.g. Barcelona" id="destination" type="text" />
